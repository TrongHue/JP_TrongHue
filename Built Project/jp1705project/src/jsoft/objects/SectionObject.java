...
public class SectionObject {
    ...
    public void setSection_manager_id(short section_manager_id) {
    ...
    public void setSection_created_author_id(short section_created_author_id) {
    ...
    public short getSection_manager_id() {
    ...
    public short getSection_created_author_id() {
    ...
    public String toString(){
        return "id " + this.getSection_id() + " section name: " + this.getSection_name();
    }
}
