...
public class AdvertiseObject {
    ...
    private short advertise_type;
    private short advertise_display;
    private String advertise_image;
    public AdvertiseObject() {
    }
    ...
    public void setAdvertise_type(short advertise_type) {
        this.advertise_type = advertise_type;
    }

    public void setAdvertise_display(short advertise_display) {
    ...
    public short getAdvertise_type() {
        return advertise_type;
    }

    public short getAdvertise_display() {
