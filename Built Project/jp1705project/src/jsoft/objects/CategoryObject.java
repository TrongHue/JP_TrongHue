...
public class CategoryObject extends SectionObject {
    ...
    private short category_created_author_id;
    private String category_last_modified;
    private short category_manager_id;
    ...
    public void setCategory_created_author_id(short category_created_author_id) {
    ...
    public void setCategory_manager_id(short category_manager_id) {
    ...
    public short getCategory_created_author_id() {
    ...
    public short getCategory_manager_id() {
    ...
    public String toString(){
        return "id: "+ this.category_id + " category name: " + this.category_name;
    }
}
